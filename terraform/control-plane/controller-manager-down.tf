...
resource "google_monitoring_alert_policy" "controller-manager-down-alert" {
  display_name = "Controller manager down (critical)"
  combiner = "OR"
  conditions {
    display_name = "Controller manager is up"
