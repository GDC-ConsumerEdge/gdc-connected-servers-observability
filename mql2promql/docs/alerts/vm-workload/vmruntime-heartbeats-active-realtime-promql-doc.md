# MQL to PromQL Conversion Guide - VMRuntime Missing Heartbeat

This document explains the proposed translations to Prometheus Query Language (PromQL) of the `alerts/vm-workload/vmruntime-heartbeats-active-realtime.yaml` alert.

## `alerts/vm-workload/vmruntime-heartbeats-active-realtime.yaml`
